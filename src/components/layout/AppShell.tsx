...
const NAV: NavItem[] = [
  ...
  { to: '/scores',             label: 'Scores',        icon: 'M9 19V6l12-2v13M9 19c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2zm12-2c0 1.105-1.343 2-3 2s-3-.895-3-2 1.343-2 3-2 3 .895 3 2z' },
  { to: '/therapeutic-safety',  label: 'Segurança Rx',  icon: 'M9 12l2 2 4-4M12 3l7 4v5c0 5-3.5 8-7 9-3.5-1-7-4-7-9V7l7-4z' },
    ...
    <div className="flex h-dvh bg-gray-50 dark:bg-gray-950 overflow-hidden">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="flex items-center gap-3 px-4 py-3 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800 lg:hidden shrink-0">
          ...
          <span className="font-semibold text-gray-900 dark:text-gray-100">Rhema Care</span>
        </header>
