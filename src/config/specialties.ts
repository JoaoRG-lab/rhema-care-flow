...
export const SPECIALTIES: SpecialtyConfig[] = [
  ...
  },
  {
    ...
    tools: [
      { label: 'Idade Gestacional', description: 'Cálculo por DUM e USG', href: '/scores', icon: Activity, badge: 'Core' },
      { label: 'Bishop Score', description: 'Avaliação do colo uterino', href: '/scores', icon: Activity },
      { label: 'Risco de Pré-eclâmpsia', description: 'Triagem 1º trimestre', href: '/scores', icon: Shield },
      { label: 'Curva de Peso Fetal', description: 'Hadlock e Intergrowth', href: '/scores', icon: Baby },
      { label: 'Protocolo HPP', description: 'Hemorragia pós-parto', href: '/knowledge', icon: Droplets },
      { label: 'Biblioteca de Conhecimento', description: 'Guidelines FEBRASGO/ACOG', href: '/knowledge', icon: Stethoscope },
    ],
